  ...
  return (
    <section className="bg-steel py-20">
      <div className="container mx-auto max-w-md">
        ...
        <p className="mt-3 text-sm leading-6 text-zinc-600">Enter your registered email and mobile number to view quotes and project progress.</p>
        ...
        <form action="/api/customer/login" method="post" className="mt-8 grid gap-4 rounded-lg border bg-white p-6 shadow-industrial">
          ...
          {error === "invalid" ? <p className="text-sm font-medium text-red-700">No customer account found for that email and mobile number.</p> : null}
          {error && error !== "invalid" ? <p className="text-sm font-medium text-red-700">Login failed. Please try again.</p> : null}
